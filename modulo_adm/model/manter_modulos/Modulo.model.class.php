...
require_once($_SERVER["DOCUMENT_ROOT"] . "modulo_adm/model/manter_modulos/object/Modulo.object.php");

class ModuloModel extends AbstractModelCore
{
    private $classe;
    private $conexao;
