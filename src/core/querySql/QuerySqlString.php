...
class QuerySqlString implements QuerySqlStringInterface
{
  ...
  private string $selectPagination = "";
  private array $joinCondition = array();
  private array $whereCondition = array();
  private array $groupByCondition = array();
  private array $orderByCondition = array();
  private array $tableColumnsData = array();
  private string $typeOrderBy = self::ASC;
