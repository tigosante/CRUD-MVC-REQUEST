...
use src\{
  ...
  interfaces\DataDB\FindAllDataInterface,
  ...
  core\Audit\Audit,
  core\DataDB\DataDB,
  core\DataDB\FindData,
  core\DataDB\FindAllData,
  core\DataDB\CreateDataDB,
  core\QuerySql\QuerySql,
  core\QuerySql\QuerySqlString,
  core\TableObject\TableObjectInfo,
  core\Pagination\Pagination,
  core\Repository\RepositoryDataDB,
...
class TableObject implements TableObjectInterface
{
  ...
  private array $ignoreFields = array(self::ACAO);
  private array $dataToTableObject = array();

  private static object $object;

  private static AuditInterface $audit;
  private static AuditObjectInterface $auditObject;
  ...
  private static DataDBInterface $dataDB;
  private static RepositoryDataDBInterface $repositoryDataDB;

  private static FindDataInterface $findData;
  private static FindAllDataInterface $findAllData;
  private static CreateDataDBInterface $createDataDB;

  private static PaginationInterface $pagination;
